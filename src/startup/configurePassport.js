...
const CookieTokenStrategy = require('../util/CookieTokenStrategy');
...
function configurePassport(app, authenticationService, usersService) {
  ...
  passport.use('cookie', new CookieTokenStrategy(authenticationService.getUserByToken.bind(authenticationService)));
